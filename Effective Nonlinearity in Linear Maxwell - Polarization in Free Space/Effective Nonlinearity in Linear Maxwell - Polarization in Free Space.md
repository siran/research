---
title: Effective Nonlinearity in Linear Maxwell
subtitle: Polarization in Free Space
author: An Rodriguez, Elias Navarro
date: 2025-10-10
one-sentence-summary: Polarization and electromagnetic waves are manifestations of the same field, and their coexistence yields effective nonlinearity within linear Maxwell theory.
summary: >
  We argue that polarization is a field state rather than a strictly material
  property. In free space, a secondary electromagnetic field can play the role
  of polarization by modifying local energy density, thereby changing effective
  propagation conditions for other disturbances. This yields measurable
  interaction effects while preserving the linear form of Maxwell's equations.
keywords:
  - Maxwell equations
  - polarization
